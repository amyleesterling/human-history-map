...
```
index.html, civ.html     the two pages, the atlas: ink on paper
scifi.html, scifi-civ.html   the same two in the black sci-fi skin, generated
                         by scripts/build-scifi.mjs (never edited by hand);
                         the moon in the bar leads there, the sun leads back
site.css                 everything both pages share, and the sci-fi paint
