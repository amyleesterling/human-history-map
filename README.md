...
vendor/                  d3-geo, d3-array, topojson-client, the scifi-ui swarm
                         the card opens with, and the Cinzel and EB Garamond
                         faces the chart is lettered in, all unmodified
