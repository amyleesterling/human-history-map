...
await data.ensureYear(1794, 0);
assert.ok(data.featuresOf('poland-1783', 1794).length > 0);
assert.equal(data.featuresOf('poland-1783', 1795).length, 0, 'the Commonwealth must not persist after its dissolution');
assert.equal(data.nearestDrawnYear('poland-1783', 1796), 1794);
