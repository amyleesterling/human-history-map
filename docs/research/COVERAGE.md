...
This inventory tracks the repository's 3032 records. It is not a claim that these are all human civilizations. Multiple snapshot IDs can describe one society, and important societies are absent.
...
| reviewedBorders | 0 |
| recordsWithLifetimeConflicts | 16 |
